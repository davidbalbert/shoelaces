...
sl_init_list(struct sl_interpreter_state *state)
{
        ...
        sl_define_function(state, "first", sl_first, "(l:List)");
        sl_define_function(state, "second", sl_second, "(l:List)");
        sl_define_function(state, "third", sl_third, "(l:List)");
        sl_define_function(state, "fourth", sl_fourth, "(l:List)");
        sl_define_function(state, "fifth", sl_fifth, "(l:List)");
        sl_define_function(state, "rest", sl_rest, "(l:List)");
